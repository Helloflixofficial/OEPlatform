...
export const CourseSidebar = ({ course, progressCount, isPurchased }: CourseSidebarProps) => {
  return (
    <div className="flex h-full min-h-0 flex-col border-r border-slate-200 bg-white">
      <div className="flex-shrink-0 border-b border-slate-200 px-6 py-6">
        ...
        {isPurchased && <div className="mt-5"><CourseProgress variant="success" value={progressCount} size="sm" /></div>}
      </div>
